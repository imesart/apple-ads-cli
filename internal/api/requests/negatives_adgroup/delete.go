...
// DeleteBulkRequest deletes ad group negative keywords in bulk.
...
func (r DeleteBulkRequest) Path() string {
	return fmt.Sprintf("/campaigns/%s/adgroups/%s/negativekeywords/delete/bulk", r.CampaignID, r.AdGroupID)
}
